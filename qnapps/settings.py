"""
Django settings for qnapps project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', '-a)fm)_xm@%_x7#3041(3@(io!a9fuvy2t)ydd(1+gyjmm^&r)')
...
WSGI_APPLICATION = 'qnapps.wsgi.application'
